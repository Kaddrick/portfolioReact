    ...
    return (
        <main className="min-h-screen bg-blue-300 ">
            ...
            <article className="block justify-center lg:mx-64 md:mx-52 sm:mx-32 bg-gray-800 my-12 rounded-lg animate-fade-in-down border-gray-500 border-4">
                ...
                Born in France and moved to the UK in 2013, i have worked for the past 8 years in hospitality industry and 
                    during the second lockdown i decided it was time for a change. I learn to code, i started with
                    a free app then moved to tutorial and practice. Then in February and March i passed two MTAs (Microsoft Technology Associate) to validate
                    my skills. 
                </p>
                <p className="text-white cursive m-4">
                I am currently as well a Dungeon Master for my group of friends playing Dungeon and Dragons. 
                This is one of my hobby i have been able to pursue despite the current pandemic, we play online
                and it inspired my first project (see the spell sheet on the project page).
                </p>
                <p className="text-white cursive m-4">
